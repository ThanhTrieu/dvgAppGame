...
const HotTopNews = ({ props }) => {
  ...
  const idPostOne = props.dataTopFocus ? (props.dataTopFocus.topFisrt ? props.dataTopFocus.topFisrt.post_id : 0) : 0

  const idPostTwo = props.dataTopFocus ? (props.dataTopFocus.topSecond ? props.dataTopFocus.topSecond.post_id : 0) : 0

  const idPostThree = props.dataTopFocus ? (props.dataTopFocus.topThird ? props.dataTopFocus.topThird.post_id : 0) : 0
